# SetForge Fitness — Marketing Copy

> This is the **single source of truth** for all copy on the promotional website.
> All text in `src/lib/site.config.ts` derives from this file.
> Update copy here first, then sync to `site.config.ts`.
...
- **Short Description**: SetForge is a privacy-first gym rep counter for Windows and Android. No account. No cloud. Just your workout.
- **Long Description**: SetForge is built for the gym floor — not a dashboard. Tap to count each rep, log the weight, save the set. Your full workout history lives on your device, searchable and private. No subscription, no account required, no data sent anywhere.

---

## Meta / SEO

- **Page Title**: SetForge — Privacy-First Gym Rep Counter
- **Meta Description**: Track your reps and sets during every workout. SetForge stores everything locally — no account, no cloud, no ads. Free for Windows and Android.
- **OG Title**: SetForge — Count Every Rep. Own Your Progress.
- **OG Description**: A privacy-first gym rep counter for Windows and Android. Your workout data stays on your device.
- **OG Image**: `/setforge-fitness/og-image.png` (to be created)
...
- **Sub-headline**: SetForge is a privacy-first gym tracker built for your workout — not your data.
- **CTA Primary**: Download for Windows
- **CTA Secondary**: Get it on Android
- **CTA Tertiary**: View on GitHub
- **Badge Label**: Free & Open Source
...
- **GitHub CTA**: View Source on GitHub
...
- **Links**:
  - GitHub: `https://github.com/amecteau/setforge-app`
  - Issues / Support: `https://github.com/amecteau/setforge-app/issues`
